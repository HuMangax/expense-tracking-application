        ...
        <form wire:submit="save" class="space-y-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Don't see your category? <a href="/categories"
                                class="text-blue-600 hover:text-blue-700 font-medium">Create one</a>
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <label
                        class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition {{ $type === 'one-time' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300' }}">
                        <input type="radio" wire:model.live="type" value="one-time" class="sr-only">
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg {{ $type === 'one-time' ? 'bg-blue-600' : 'bg-gray-300' }} flex items-center justify-center">
                    ...
                    <label
                        class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition {{ $type === 'recurring' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300' }}">
                        <input type="radio" wire:model.live="type" value="recurring" class="sr-only">
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg {{ $type === 'recurring' ? 'bg-blue-600' : 'bg-gray-300' }} flex items-center justify-center">
                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select wire:model="recurring_frequency" id="recurring_frequency"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('recurring_frequency') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="date" id="recurring_start_date" wire:model="recurring_start_date"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('recurring_start_date') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="date" id="recurring_end_date" wire:model="recurring_end_date"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('recurring_end_date') border-red-500 @enderror">
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit"
                    class="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:-translate-y-0.5 flex items-center gap-2">
